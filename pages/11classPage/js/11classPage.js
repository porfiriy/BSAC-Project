...
//Кнопка показать стоимость
WantKnowPaymentInfoBtn1.onclick = function () {//при нажатии на элем home в меню навигац
   PaymentInfoContainer1.style = "display: flex;";

   //удаляем кнопку
   WantKnowPaymentInfoBtn1.style = "display: none;";
}
//Кнопка показать стоимость
WantKnowPaymentInfoBtn2.onclick = function () {//при нажатии на элем home в меню навигац
   PaymentInfoContainer2.style = "display: flex;";

   //удаляем кнопку
   WantKnowPaymentInfoBtn2.style = "display: none;";
}
//Кнопка показать стоимость
WantKnowPaymentInfoBtn3.onclick = function () {//при нажатии на элем home в меню навигац
   PaymentInfoContainer3.style = "display: flex;";

   //удаляем кнопку
   WantKnowPaymentInfoBtn3.style = "display: none;";
}
//----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------